      ...
      <section className="benefits">
        ...
        <div className="benefits-grid">
          ...
          <div className="benefit-card">
            ...
            <ul>
              <li>Fácil acesso aos pontos de coleta.</li>
              <li>Melhoria das áreas verdes ao descarte correto do lixo.</li>
              <li>Incentivo a ecologia.</li>
            </ul>
          </div>
          <div className="benefit-card">
            <h3>Para o Governo</h3>
            <ul>
              <li>Menos custos com problemas relacionados ao discarte incorreto.</li>
